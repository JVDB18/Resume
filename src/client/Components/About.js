...
class About extends React.Component{
    render(){
        return <div className="SectionContainer">
                            ...
                            Let me introduce myself: Julie, <strong>Junior Front-End Developer currently looking for a fresh new internship / hiring opportunity.</strong>
                            ...
                            I have learned to learn, in a fast and efficient way, making of my time a valuable product. Isn't it the coolest superpower an employee could have?
                                <br/>
