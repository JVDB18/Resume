    ...
    render(){
        return <div className="SectionContainer">
                            ...
                            At this point you are questionning yourself: <i>"What a freshman junior dev / former nurse can do in my company? "</i>
                                ...
                                <br/>
                                First thing i would tell you is that with enthusiasm, passion, and a little bit of ambition's adrenaline, you can accomplish anything. <p className="whisper">- Thanks to te little chimist in your head - </p>
